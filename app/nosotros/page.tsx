    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2
            className="text-3xl sm:text-4xl text-[#0A4D8C] font-semibold mt-3 mb-6"
            style={{ fontFamily: "var(--font-playfair)" }}
          >
            Una clínica pensada para ti
          </h2>
          <div className="space-y-5 text-[#1A1A2E] text-lg leading-relaxed">
            <p>
      ...
      <section className="py-20 bg-[#F8FAFF]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2
              className="text-3xl sm:text-4xl text-[#0A4D8C] font-semibold mt-3"
              style={{ fontFamily: "var(--font-playfair)" }}
            >
          ...
          <div className="grid gap-8 sm:grid-cols-2">
            {equipo.map((doc) => (
              ...
              >
                <div className="relative w-32 h-32 sm:w-36 sm:h-36 flex-shrink-0 rounded-full overflow-hidden ring-4 ring-[#00A8E8]/15">
                  <Image
                    src={doc.imagen}
                    alt={doc.nombre}
                    fill
                ...
                <div className="flex-1">
                  <h3
                    className="text-xl text-[#0A4D8C] font-semibold mb-1"
                    style={{ fontFamily: "var(--font-playfair)" }}
                  >
                    {doc.nombre}
                  </h3>
                  <p className="text-sm font-medium text-[#00A8E8] mb-1">
                    {doc.especialidad}
                  </p>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {pilares.map((p) => {
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-[#0A4D8C] to-[#00A8E8] flex items-center justify-center mb-5">
